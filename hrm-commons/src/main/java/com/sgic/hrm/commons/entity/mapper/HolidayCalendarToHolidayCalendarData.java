...
public class HolidayCalendarToHolidayCalendarData {
	...
	public static HolidayCalendarData mapToHolidayCalendarData(HolidayCalendar holidayCalendar) {
		...
		if(holidayCalendar != null) {
			...
			holidayCalendarData.setEnteredBy(UserToUserData.mapToUserData(holidayCalendar.getEnteredBy()));
		}
		return holidayCalendarData;
	}
	
	public static List<HolidayCalendarData> mapToHolidayCalendarDataList(List<HolidayCalendar> holidayCalendarList){
