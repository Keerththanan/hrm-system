...
public class AcceptCancelRequestToAcceptCancelRequestData {
	...
	public static AcceptCancelRequestData mapToAcceptCancelRequestData(AcceptCancelRequest acceptCancelRequest) {
		...
		if (acceptCancelRequest != null) {
			...
			acceptCancelRequestData.setAcceptedBy(UserToUserData.mapToUserData(acceptCancelRequest.getAcceptedBy()));
	...
	public static List<AcceptCancelRequestData> mapToAcceptCancelRequestDataList(
		...
		List<AcceptCancelRequestData> acceptCancelRequestDataList = new ArrayList<AcceptCancelRequestData>();
