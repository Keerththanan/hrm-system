...
public class AcceptLeaveRequestToAcceptLeaveRequestData {
	...
	public static AcceptLeaveRequestData mapToAcceptLeaveRequestData(AcceptLeaveRequest acceptLeaveRequest) {
		...
		if (acceptLeaveRequest != null) {
			...
			acceptLeaveRequestData.setAcceptedBy(UserToUserData.mapToUserData(acceptLeaveRequest.getAcceptedBy()));
			acceptLeaveRequestData.setLeaveRequest(
					LeaveRequestToLeaveRequestData.mapToLeaveRequestData(acceptLeaveRequest.getLeaveRequest()));
		}
	...
	public static List<AcceptLeaveRequestData> mapToAcceptLeaveRequestData(
		...
		List<AcceptLeaveRequestData> acceptLeaveRequestDataList = new ArrayList<AcceptLeaveRequestData>();
