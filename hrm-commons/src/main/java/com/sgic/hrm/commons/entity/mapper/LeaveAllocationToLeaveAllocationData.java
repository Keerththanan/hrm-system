...
public class LeaveAllocationToLeaveAllocationData {
	...
	public static LeaveAllocationData mapToLeaveAllocationData(LeaveAllocation leaveAllocation) {
		...
		if(leaveAllocation != null) {
			...
			leaveAllocationData.setLeaveType(LeaveTypeToLeaveTypeData.mapToLeaveTypeData(leaveAllocation.getLeaveType()));
		}
		return leaveAllocationData;
	}
	
	public static List<LeaveAllocationData> mapToLeaveAllocationDataList(List<LeaveAllocation> leaveAllocationList){
