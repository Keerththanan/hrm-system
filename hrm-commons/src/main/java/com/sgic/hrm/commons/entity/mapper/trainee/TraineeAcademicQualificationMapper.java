...
public class TraineeAcademicQualificationMapper {
	public static TraineeAcademicQualificationDto mapAcademicQualificationToAcademicQualificationDto(
			TraineeAcademicQualification traineeAcademicQualification) {
	...
	public static List<TraineeAcademicQualificationDto> mapAcademicQualificationListToAcademicQualificationDtoList(
			List<TraineeAcademicQualification> academicQualificationList) {
		...
		if (academicQualificationList != null) {
			for (TraineeAcademicQualification traineeAcademicQualification : academicQualificationList)
				academicQualificationDtoList
						.add(mapAcademicQualificationToAcademicQualificationDto(traineeAcademicQualification));
		}
