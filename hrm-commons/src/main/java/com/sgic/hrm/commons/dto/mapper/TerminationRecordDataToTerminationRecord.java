...
public class TerminationRecordDataToTerminationRecord {
	public static TerminationRecord mapToTerminationRecord(TerminationRecordData terminationRecordData) {
		...
		if(terminationRecordData != null) {
			...
			terminationRecord.setTerminationType(TerminationTypeDataToTerminationType.mapToTerminationType(terminationRecordData.getTerminationType()));
			return terminationRecord;
		}
		return null;
	}
	
	public static List<TerminationRecord> mapToTerminationRecordtList(List<TerminationRecordData> terminationRecordDataList) {
