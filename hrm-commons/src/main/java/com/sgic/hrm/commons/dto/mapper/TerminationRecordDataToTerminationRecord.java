...
public class TerminationRecordDataToTerminationRecord {
  ...
  public static TerminationRecord mapToTerminationRecord(
      TerminationRecordData terminationRecordData) {
    ...
    if (terminationRecordData != null) {
      ...
      terminationRecord
          .setDisciplinaryProcedures(terminationRecordData.getDisciplinaryProcedures());
