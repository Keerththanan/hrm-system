...
public class SelfService implements Serializable {
  ...
  private SelfServiceType selfServiceTypeId;
  @ManyToOne
  ...
  public SelfServiceType getSelfServiceTypeId() {
    return selfServiceTypeId;
  }

  public void setSelfServiceTypeId(SelfServiceType selfServiceTypeId) {
    this.selfServiceTypeId = selfServiceTypeId;
  }
