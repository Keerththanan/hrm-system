...
public class RejectCancelRequestToRejectCancelRequestData {
	...
	public static RejectCancelRequestData mapToRejectCancelRequestData(RejectCancelRequest rejectCancelRequest) {
		...
		if (rejectCancelRequest != null) {
			...
			rejectCancelRequestData.setUser(UserToUserData.mapToUserData(rejectCancelRequest.getUser()));
		}
	...
	public static List<RejectCancelRequestData> mapToRejectCancelRequestDataList(
		...
		List<RejectCancelRequestData> rejectCancelRequestDataList = new ArrayList<RejectCancelRequestData>();
