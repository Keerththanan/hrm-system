...
public class CarryforwardRequestToCarryforwardRequestData {
	...
	public static CarryforwardRequestData mapToCarryforwardRequestData(CarryforwardRequest carryforwardRequest) {
		...
		if(carryforwardRequest != null) {
			...
			carryforwardRequestData.setStatus(StatusToStatusData.mapToStatusData(carryforwardRequest.getStatus()));
		}
		return carryforwardRequestData;
	}
	
	public static List<CarryforwardRequestData> mapToCarryforwardRequestDataList(List<CarryforwardRequest> carryforwardRequestList){
		List<CarryforwardRequestData> carryforwardRequestDataList = new ArrayList<CarryforwardRequestData>();
