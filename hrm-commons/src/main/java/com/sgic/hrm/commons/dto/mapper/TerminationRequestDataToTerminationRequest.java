...
public class TerminationRequestDataToTerminationRequest {
	...
	public static TerminationRequest mapToTerminationRequest(TerminationRequestData terminationRequestData ) {
		...
		if (terminationRequestData != null) {
			...
			terminationRequest.setEmployee(UserDataToUser.mapToUser(terminationRequestData.getEmployee()));
			terminationRequest.setTerminationType(TerminationTypeDataToTerminationType.mapToTerminationType(terminationRequestData.getTerminationType()));
	...
	public static List<TerminationRequest> mapToTerminationRequestList(List<TerminationRequestData> terminationRequestDataList) {
