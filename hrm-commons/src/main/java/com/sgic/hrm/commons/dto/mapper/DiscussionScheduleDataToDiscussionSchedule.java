...
public class DiscussionScheduleDataToDiscussionSchedule {
	...
	public static DiscussionSchedule mapToDiscussionSchedule(DiscussionScheduleData discussionScheduleData ) {
		...
		if (discussionScheduleData != null) {
			...
			discussionSchedule.setTerminationRequest(TerminationRequestDataToTerminationRequest.mapToTerminationRequest(discussionScheduleData.getTerminationRequest()));
	...
	public static List<DiscussionSchedule> mapToDiscussionScheduleList(List<DiscussionScheduleData> discussionScheduletDataList) {
