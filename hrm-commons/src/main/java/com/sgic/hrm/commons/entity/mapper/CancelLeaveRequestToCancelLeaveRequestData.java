...
public class CancelLeaveRequestToCancelLeaveRequestData {
	...
	public static CancelLeaveRequestData mapToCancelLeaveRequestData(CancelLeaveRequest cancelLeaveRequest) {
		...
		if (cancelLeaveRequest != null) {
			...
			cancelLeaveRequestData.setLeaveRequest(LeaveRequestToLeaveRequestData.mapToLeaveRequestData(cancelLeaveRequest.getLeaveRequest()));
			cancelLeaveRequestData.setStatus(StatusToStatusData.mapToStatusData(cancelLeaveRequest.getStatus()));
		}
		return cancelLeaveRequestData;
	}
	
	public static List<CancelLeaveRequestData> mapToCancelLeaveRequestData(List<CancelLeaveRequest> cancelLeaveRequestList){
		List<CancelLeaveRequestData> cancelLeaveRequestDataList = new ArrayList<CancelLeaveRequestData>();
