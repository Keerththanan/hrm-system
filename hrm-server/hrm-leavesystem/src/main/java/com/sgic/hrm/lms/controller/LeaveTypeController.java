...
public class LeaveTypeController {
	...
	public ResponseEntity<String> createLeaveType(@RequestBody LeaveTypeData leaveTypeData) {
		LeaveType leaveType = LeaveTypeDataToLeaveType.mapToLeaveType(leaveTypeData);
		if (leaveTypeService.createLeaveType(leaveType)) {
	...
	public ResponseEntity<List<LeaveTypeData>> getAllLeaveType() {
		List<LeaveType> leaveTypeList = leaveTypeService.viewAllLeaveType();
		return new ResponseEntity<>(LeaveTypeToLeaveTypeData.mapToLeaveTypeDataList(leaveTypeList), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> editLeaveType(@RequestBody LeaveTypeData leaveTypeData,
		...
		if (leaveTypeService.updateLeaveType(id, LeaveTypeDataToLeaveType.mapToLeaveType(leaveTypeData))) {
