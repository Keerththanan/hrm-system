...
//		List<RequestPromotionData> reqPromotionData = requestPromotionService.getAllRequestPromotion();
//		ResponseEntity<List<RequestPromotionData>> response = new ResponseEntity<>(reqPromotionData, HttpStatus.OK);
//		return response;
//	}
//
//	@PutMapping("/promotion/{id}")
//	public HttpStatus updateRequestPromotion(@PathVariable Integer id, @RequestBody RequestPromotionData requestPromotionData) {
