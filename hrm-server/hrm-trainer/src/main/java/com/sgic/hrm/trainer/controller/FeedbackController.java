...
public class FeedbackController {
	...
	public ResponseEntity<List<FeedbackDto>> getAllFeedback(){
		return new ResponseEntity<>(FeedbackMapper
				.mapFeedbackListToFeedbackDtoList(feedbackService.getFeedback()),
				HttpStatus.OK);
	}
	@PostMapping("/feedback")
	public HttpStatus addFeedback(@RequestBody FeedbackSaveDto feedbackSaveDto) {
		boolean test = feedbackService.createFeedback(FeedbackDtoMapper.mapFeedbackSaveDtoToFeedback(feedbackSaveDto));
	if(test) {
...
>>>>>>> d1607cf77b52ebde09b2efe087ef0ae99175b8d5
